...
<template>
  <InspectorFieldShell
    :title="props.field.label || 'Untitled textarea field'"
  ...
  >
    ...
    <label class="field-stack">
      <span>Default</span>
      <textarea rows="4" :value="props.field.default || ''" @input="updateValue('default', ($event.target as HTMLTextAreaElement).value)" />
    </label>
    <label class="field-stack">
      <span>Info</span>
