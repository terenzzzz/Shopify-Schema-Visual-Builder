...
<template>
  <InspectorFieldShell
    :title="props.field.label || 'Untitled richtext field'"
  ...
  >
    ...
    <label class="field-stack">
      <span>Richtext 默认值</span>
      <textarea rows="5" :value="props.field.default || ''" @input="updateValue('default', ($event.target as HTMLTextAreaElement).value)" />
    </label>
    <label class="field-stack">
      <span>Info</span>
