...
const emit = defineEmits<{
  patch: [payload: Partial<SelectFieldType>]
  remove: []
}>()

const updateValue = (key: keyof SelectFieldType, value: string) => {
  emit('patch', { [key]: value } as Partial<SelectFieldType>)
}
...
<template>
  <InspectorFieldShell
    :title="props.field.label || 'Untitled select field'"
